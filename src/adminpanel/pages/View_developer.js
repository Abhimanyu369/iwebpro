       ...
       <div className="table_section mt-5">
          <div className="table-responsive-sm">
            <div className="d-flex justify-content-between align-items-center">
              ...
              <a href="/add_developer" className="btn btn-primary text-white my-4">Add Developer</a>
            </div>
                ...
                {dev.map((v)=>{
                      return (
                        <tr key={v._id}>
                          ...
                          <td><div className="d-flex"><Link className="py-2 px-3 me-3 btn-primary text-white" to={"/Update_developer?id="+v._id}>Update</Link><Link className="py-2 px-3 btn-primary text-white" onClick={(e) => {e.preventDefault(); Delete(v._id)}}>Delete</Link></div></td>
                        </tr>
                      )
                    })}
                </tbody>
