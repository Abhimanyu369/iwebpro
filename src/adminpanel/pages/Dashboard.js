    ...
    <><Header />
      ...
      <div className="layout-container">
          ...
          <div className="container-xxl flex-grow-1 container-p-y">
            <div className="row" style={{width: '85%', position: 'absolute', top: '12%', left: '15%'}}>
                  ...
                  <div className="d-flex align-items-end row">
                    <div className="col-sm-7">
                      <div className="card-body">
                        ...
                        <span className="btn btn-sm btn-outline-primary">View Badges</span>
                      </div>
                    </div>
                    <div className="col-sm-5 text-center text-sm-left">
                      <div className="card-body pb-0 px-0 px-md-4">
                        <img
                          src={BACKEND_COMMAN_URL+"/img/illustrations/man-with-laptop-light.png"}
                          height="140"
                          alt="View Badge User"
                      ...
                      <div className="card-body">
                        <div className="card-title d-flex align-items-start justify-content-between">
                          <div className="avatar flex-shrink-0">
                            <img
                              src={BACKEND_COMMAN_URL+"/img/unicons/chart-success.png"}
                              alt="chart success"
                              className="rounded"
                            />
                          </div>
                          <div className="dropdown">
                            ...
                            <div className="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt3">
                              <span className="dropdown-item" >View More</span>
                    ...
                    <div className="card">
                      <div className="card-body">
                        <div className="card-title d-flex align-items-start justify-content-between">
                          <div className="avatar flex-shrink-0">
                            <img
                              src={BACKEND_COMMAN_URL+"/img/unicons/wallet-info.png"}
                              alt="Credit Card"
                              className="rounded"
                            />
                          </div>
                  ...
                  <div className="row row-bordered g-0">
                    <div className="col-md-8">
                      ...
                      <div id="totalRevenueChart" className="px-2">
                        <p className="px-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque consectetur, beatae ab facere ipsa veniam! Aut officia iste amet consequuntur quidem quae porro tenetur exercitationem? Quia sint in voluptatibus aliquam.</p>
                        <span className="btn btn-sm btn-outline-primary mx-3">View Badges</span>
                      </div>
                    </div>
                        ...
                        <div className="text-center">
                          <div className="dropdown">
                            ...
                            <div className="dropdown-menu dropdown-menu-end" aria-labelledby="growthReportId">
                              <span className="dropdown-item" >2021</span>
                              <span className="dropdown-item" >2020</span>
                              <span className="dropdown-item" >2019</span>
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="col-6 mb-4">
                    <div className="card">
                      <div className="card-body">
                        <div className="card-title d-flex align-items-start justify-content-between">
                          <div className="avatar flex-shrink-0">
                            <img src={BACKEND_COMMAN_URL+"/img/unicons/paypal.png"} alt="Credit Card" className="rounded" />
                          </div>
                          <div className="dropdown">
                            <button
                              className="btn p-0"
                  ...
                  <div className="col-6 mb-4">
                    <div className="card">
                      <div className="card-body">
                        <div className="card-title d-flex align-items-start justify-content-between">
                          <div className="avatar flex-shrink-0">
                            <img src={BACKEND_COMMAN_URL+"/img/unicons/cc-primary.png"} alt="Credit Card" className="rounded" />
                          </div>
                          <div className="dropdown">
                            <button
                              className="btn p-0"
