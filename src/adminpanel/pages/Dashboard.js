      ...
      <div className='flex flex-col flex-1 relative overflow-x-hidden overflow-y-auto'>
        ...
        <div className="ml-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
              <div className="rounded-sm border border-stroke bg-white py-6 px-7.5 shadow-default dark:border-strokedark dark:bg-boxdark px-3">
                <div className="h-11.5 w-11.5 items-center justify-center rounded-full bg-meta-2 dark:bg-meta-4">
                  <svg className="fill-primary" width="22" height="16" viewBox="0 0 22 16" fill="#000"
                ...
                <div className="mt-4 flex items-end justify-between">
                  ...
                  <span className="flex items-center gap-1 text-sm font-medium text-meta-3">
                    0.43%
                    <svg className="fill-meta-3" width="10" height="11" viewBox="0 0 10 11" fill="#000"
                      xmlns="http://www.w3.org/2000/svg">
                      <path
              ...
              <div className="rounded-sm border border-stroke bg-white py-6 px-7.5 shadow-default dark:border-strokedark dark:bg-boxdark px-3">
                ...
                <div className="mt-4 flex items-end justify-between">
                  ...
                  <span className="flex items-center gap-1 text-sm font-medium text-meta-5">
                    0.95%
                    <svg className="fill-meta-5" width="10" height="11" viewBox="0 0 10 11" fill="#000"
                      xmlns="http://www.w3.org/2000/svg">
                      <path
            ...
            <div className="mt-4 grid grid-cols-12 gap-4 md:mt-6 md:gap-6 2xl:mt-7.5 2xl:gap-7.5">
                ...
                <div className="rounded-sm border border-stroke bg-white px-5 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
                  ...
                  <div className="flex flex-col">
                    ...
                    <div className="grid grid-cols-3 border-b border-stroke dark:border-strokedark sm:grid-cols-5">
                      <div className="flex items-center gap-3 p-2.5 xl:p-5">
                        <div className="flex-shrink-0">
                          <img src="assets/img/brand/brand-04.svg" alt="Brand" />
                        </div>
              ...
              <div className="col-span-12 rounded-sm border border-stroke bg-white py-6 shadow-default dark:border-strokedark dark:bg-boxdark xl:col-span-4 px-3">
