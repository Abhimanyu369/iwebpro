            ...
            <table className="w-full table-auto">
              <thead>
                <tr className='text-dark'>
                  ...
                  <th className='border-b border-[#eee] pb-3 px-3 dark:border-strokedark'>Time</th>
                  <th className='border-b border-[#eee] pb-3 px-3 dark:border-strokedark'>Time Type</th>
                  <th className='border-b border-[#eee] pb-3 px-3 dark:border-strokedark'>Requirement</th>
              ...
              <tbody>
                {hire.map((v)=>{
                  return (
                    <tr key={v._id}><td>{v.company_name}</td>
                      ...
                      <td className='border-b border-[#eee] py-4 px-3 dark:border-strokedark'>{v.time}</td>
                      <td className='border-b border-[#eee] py-4 px-3 dark:border-strokedark'>{v.time_type}</td>
                      <td className='border-b border-[#eee] py-4 px-3 dark:border-strokedark'>{v.requirement}</td>
