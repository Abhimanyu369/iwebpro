    ...
    <form  method="post" className="col-8 position-absolute d-flex flex-wrap" onSubmit={formSubmit} style={{marginTop: '130px', marginLeft: '180px', top: 0}}>
     <div className="col-12">
      ...
      <div className="col-4 px-3 mb-4">
        ...
        <input className="form-control" type="text" name="full_name" id='full_name' value={data.full_name} onChange={(e)=> setData({...data,full_name : e.target.value})} placeholder="Full Name" />
      </div><br />
      <div className="col-4 px-3 mb-4">
        <label>Designation:-</label>
        <input type="text" name="designation" id='designation' className="form-control" value={data.designation} onChange={(e)=> setData({...data,designation : e.target.value})}  placeholder="Designation"/>
      </div><br />
      <div className="col-4 px-3 mb-4">
        <label>Expertise:-</label>
        <input type="text" name="expertise" id='expertise' className="form-control" value={data.expertise} onChange={(e)=> setData({...data,expertise : e.target.value})} placeholder="Expertise"/>
      </div><br />
      <div className="col-4 px-3 mb-4">
        <label>Enter Email :-</label>
        <input className="form-control" type="email" name="email" id='email' value={data.email} onChange={(e)=> setData({...data,email : e.target.value})} placeholder="Email" />
      </div><br />
      <div className="col-4 px-3 mb-4">
        <label>Enter Rate :-</label>
        <input className="form-control" type="number" min={1} name="rate" id='rate' value={data.rate} onChange={(e)=> setData({...data,rate : e.target.value})} placeholder="Rate" />
      </div><br />
      <div className="col-4 px-3 mb-4">
        <label>Technology:-</label>
        <input type="text" name="technology" id='technology' className="form-control" value={data.technology} onChange={(e)=> setData({...data,technology : e.target.value})} placeholder="Technology"/>
      </div><br />
      <div className="col-4 px-3 mb-4">
        <label>Framework:-</label>
        <input type="text" name="framework" id='framework' className="form-control" value={data.framework} onChange={(e)=> setData({...data,framework : e.target.value})} placeholder="Framework"/>
      </div><br />
      <div className="col-4 px-3 mb-4">
        <label>Programming Language:-</label>
        <input type="text" name="programming_language" id='programming_language' className="form-control" value={data.programming_language} onChange={(e)=> setData({...data,programming_language : e.target.value})} placeholder="Programming Language"/>
      </div><br />
      <div className="col-4 px-3 mb-4">
        <label>Browser:-</label>
        <input type="text" name="browser" id='browser' className="form-control" value={data.browser} onChange={(e)=> setData({...data,browser : e.target.value})} placeholder="Browser"/>
      </div><br />
      <div className="col-4 px-3 mb-4">
        <label>Database:-</label>
        <input type="text" name="database" id='database' className="form-control" value={data.database} onChange={(e)=> setData({...data,database : e.target.value})} placeholder="Database" />
      </div><br />
      <div className="col-4 px-3 mb-4">
        <label>Web Server:-</label>
        <input type="text" name="web_server" id='web_server' className="form-control" value={data.web_server} onChange={(e)=> setData({...data,web_server : e.target.value})} placeholder="Web Server" />
      </div><br />
      <div className="col-4 px-3 mb-4">
        <label>Operating System:-</label>
        <input type="text" name="operating_system" id='operating_system' className="form-control" value={data.operating_system} onChange={(e)=> setData({...data,operating_system : e.target.value})} placeholder="Operating System" />
      </div><br />
      <div className="col-6 px-3 mb-4">
        <label>Enter Experience :-</label>
        <input className="form-control" type="number" name="experience" id='experience' value={data.experience} onChange={(e)=> setData({...data,experience : e.target.value})} placeholder="Experience" />
      </div><br />
      <div className="col-6 px-3 mb-4" id="tec">
        <label>Enter Linkedin URL :-</label>
        <input className="form-control mb-3" type="text" name="linkedin" id='linkedin'  value={data.linkedin} onChange={(e)=> setData({...data,linkedin : e.target.value})} placeholder="Linkedin URL" />
      </div>
