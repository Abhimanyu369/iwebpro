                     ...
                     <div className="card-body">
                       <div className="card-title d-flex align-items-start justify-content-between">
                         <div className="avatar flex-shrink-0">
                           <img
                             src="/img/unicons/chart-success.png"
                             alt="chart success"
                             className="rounded"
                           />
                         </div>
                   ...
                   <div className="card">
                     <div className="card-body">
                       <div className="card-title d-flex align-items-start justify-content-between">
                         <div className="avatar flex-shrink-0">
                           <img
                             src="/img/unicons/wallet-info.png"
                             alt="Credit Card"
                             className="rounded"
                           />
                         </div>
                 ...
                 <div className="row row-bordered g-0">
                   <div className="col-md-8">
                     ...
                     <div id="totalRevenueChart" className="px-2">
                        ...
                        <a href="javascript:;" className="btn btn-sm btn-outline-primary mx-3">View Badges</a>
                     </div>
                   </div>
                 ...
                 <div className="col-6 mb-4">
                   <div className="card">
                     <div className="card-body">
                       <div className="card-title d-flex align-items-start justify-content-between">
                         <div className="avatar flex-shrink-0">
                           <img src="/img/unicons/paypal.png" alt="Credit Card" className="rounded" />
                         </div>
                         <div className="dropdown">
                           <button
                             className="btn p-0"
                 ...
                 <div className="col-6 mb-4">
                   <div className="card">
                     <div className="card-body">
                       <div className="card-title d-flex align-items-start justify-content-between">
                         <div className="avatar flex-shrink-0">
                           <img src="/img/unicons/cc-primary.png" alt="Credit Card" className="rounded" />
                         </div>
                         <div className="dropdown">
                           <button
                             className="btn p-0"
